...
function FullNavbar() {
  ...
  return (
    <nav className="duration-50 left-0 top-0 z-50 hidden items-center bg-white shadow-lg ease-in md:fixed md:flex md:h-[72px] md:w-full 2xl:h-[80px]">
      <div className="mr-0 px-4 md:ml-0 md:w-full 2xl:ml-[152px]">
        <div className="flex w-full items-center justify-between">
          ...
          <ul className="font-montserrat mr-[2%] flex gap-8 text-[#5B5A5A] md:ml-12 md:text-xs lg:space-x-3 lg:text-base 2xl:space-x-8 2xl:text-lg 2xl:font-semibold">
