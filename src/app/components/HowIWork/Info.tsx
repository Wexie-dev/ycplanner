  ...
  return (
    <div className="text-[#36373A] xl:flex xl:justify-center xl:pb-10 xl:pt-16">
      ...
      <div className="relative sm:flex sm:items-center sm:justify-center xl:block">
        <div className="relative h-[376px] w-[314px] md:h-[489px] md:w-[405px] lg:h-[872px] lg:w-[729px] xl:h-[586px] xl:w-[486px] 2xl:mb-28 2xl:h-[872px] 2xl:w-[729px]">
          <Image
            fill
            ...
            alt={'yanina'}
            placeholder="blur"
            blurDataURL="images/blur-yanina.png"
          />
        </div>
