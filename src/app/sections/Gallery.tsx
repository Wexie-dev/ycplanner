  ...
  return (
    <section id="gallery" className="h-screen w-full pt-20">
      ...
      <div className="h-full w-full">
        <div className="mx-[10px] h-[1592px] lg:mx-[24px] lg:h-[424px] 2xl:mx-[72px] 2xl:h-[776px]">
          <div className="flex h-full w-full flex-col justify-center gap-[8px] sm:flex-row lg:gap-[8px] 2xl:gap-[16px]">
