          ...
          <div className="flex h-full w-full flex-col justify-center gap-[8px] sm:flex-row sm:gap-[8px] 2xl:gap-[16px]">
            <div className="mx-auto flex-col sm:mx-0">
              <img
                ...
                alt="Imagen 1"
                className="mb-[8px] h-[192px] w-[328px] bg-slate-500 object-cover sm:mb-[8px] sm:h-[176px] sm:w-[237px] 2xl:mb-[16px] 2xl:h-[320px] 2xl:w-[432px]"
              />
              <img
                src={isMobile ? mobileImages[1].url : images[1].url}
                alt="Imagen 2"
                className="h-[192px] w-[328px] bg-slate-500 object-cover sm:h-[240px] sm:w-[237px] 2xl:h-[440px] 2xl:w-[432px]"
              />
            </div>
            <div className="mx-auto flex-col sm:mx-0">
              <img
                ...
                alt="Imagen 3"
                className="mb-[8px] h-[192px] w-[328px] bg-slate-500 object-cover sm:mb-[8px] sm:h-[248px] sm:w-[240px] 2xl:mb-[16px] 2xl:h-[448px] 2xl:w-[432px]"
              />
              <img
                src={isMobile ? mobileImages[3].url : images[3].url}
                alt="Imagen 4"
                className="h-[192px] w-[328px] bg-slate-500 object-cover sm:h-[168px] sm:w-[240px] 2xl:h-[312px] 2xl:w-[432px]"
              />
            </div>
            <div className="mx-auto flex-col sm:mx-0">
              <img
                ...
                alt="Imagen 5"
                className="mb-[8px] h-[192px] w-[328px] bg-slate-500 object-cover sm:mb-[8px] sm:h-[208px] sm:w-[240px] 2xl:mb-[16px] 2xl:h-[380px] 2xl:w-[432px]"
              />
              <img
                src={isMobile ? mobileImages[5].url : images[5].url}
                alt="Imagen 6"
                className="h-[192px] w-[328px] bg-slate-500 object-cover sm:h-[208px] sm:w-[240px] 2xl:h-[380px] 2xl:w-[432px]"
              />
            </div>
            <div className="mx-auto flex-col sm:mx-0">
              <img
                ...
                alt="Imagen 7"
                className="mb-[8px] h-[192px] w-[328px] bg-slate-500 object-cover sm:mb-[8px] sm:h-[280px] sm:w-[235px] 2xl:mb-[16px] 2xl:h-[512px] 2xl:w-[432px]"
              />
              <img
                src={isMobile ? mobileImages[7].url : images[7].url}
                alt="Imagen 8"
                className="h-[192px] w-[328px] bg-slate-500 object-cover sm:h-[136px] sm:w-[235px] 2xl:h-[248px] 2xl:w-[432px]"
              />
            </div>
          </div>
        </div>
