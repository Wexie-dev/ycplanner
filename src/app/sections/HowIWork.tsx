...
import howIWork_image from '../../../public/images/howIWork-image.svg';
...
function HowIWork(howIWorkProps: HowIWorkProps) {
  ...
  return (
    <section className="h-screen w-full bg-[#E9EAED] pt-16 lg:pt-[72px]" id="howIWork">
      {/* Como trabajo */}
      <div className="bg-[#E9EAED] text-[#36373A]">
        <div className="flex justify-center pt-2 font-butler text-2xl font-normal lg:text-5xl">
          {title1}
        </div>
        <div className="static h-[373px] lg:h-[872px]">
          <Image
            ...
            className="relative z-20 ml-4 mt-8 lg:ml-[128px] lg:mt-[86px]"
            src={`${image}`}
            alt={''}
          />
          <div className="relative -top-[392px] left-10 z-10 h-[352px] w-[304px] bg-[#AD837E] opacity-50 drop-shadow-[0_11px_48px_0_rgb(#00000033)] lg:-top-[910px] lg:left-[184px] lg:h-[826px] lg:w-[712px]"></div>
        </div>
        <div className="pl-10 font-normal lg:pl-32 lg:pr-80">
          <div className="flex pt-10 font-butler text-2xl lg:text-4xl">{subtitle1}</div>
          <div className="flex pr-10 pt-2 text-base lg:pt-4">{paragraph1}</div>
          <div className="flex pt-6 font-butler text-2xl lg:pt-9 lg:text-4xl">{subtitle2}</div>
          <div className="">
          ...
          <div className="flex pt-8 font-bellina text-2xl text-[#996058] lg:pt-12 lg:text-4xl">
            {subtitle3}
          </div>
      ...
      <div className="bg-[#F5F5F5]">
        <div className="flex justify-center pt-12 font-bellina text-2xl text-[#996058] lg:justify-start lg:pl-36 lg:pt-[100px] lg:text-5xl">
          {title2}
        </div>
        <div className="flex flex-col px-[92px] pt-14 lg:flex-row lg:flex-wrap lg:gap-14 lg:pb-10 lg:pl-[140px] lg:pt-20">
          {serviceDetails.map((service, index) => (
            <div
              key={index}
              className="flex flex-col items-center pb-8 text-center text-sm font-normal text-[#36373A] lg:w-[336px] lg:pb-0 lg:text-base"
            >
              <Image
